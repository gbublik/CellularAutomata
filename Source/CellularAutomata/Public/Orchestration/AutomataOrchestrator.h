...
public:
	 ...
	 *  которых перенос вообще работает (толщина 2, соседство Moore, States 2,
	 ...
	 *  а прошлое нигде не записано. Смена правила/соседства/States посреди
	 ...
	 *  чётности, соседство, растяжение решётки по Z и множитель меша - и
...
public:
	 ...
	 *  Z и соседство-списком, но не форму и не меш (см. FAutomatonSaveHeader -
	 ...
	 *  выставляется ДО правила: пресет формы задаёт в том числе соседство, и в
	 *  обратном порядке он затёр бы соседство из строки правила - ровно тот
...
private:
	 ...
	 *  формы затрёт соседство, только что разобранное из строки правила, - и при
